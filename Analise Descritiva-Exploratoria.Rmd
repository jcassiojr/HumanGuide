...
Abaixo são apresentados os resultados de análises de classificações realizadas, de forma a permitir uma avaliação mais apurada e abrangente do significado de cada componente principal obtido.
...
pc6 <- layout(pc6, title = "MANAGEMENT x ASSISTÊNCIA/RECEPTIVIDADE ATIVA")
pc6
```
