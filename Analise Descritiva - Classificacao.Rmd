...
---
    ...
    Este documento descreve a análise descritiva exploratória/preditiva, realizada com o objetivo de definir um algoritmo 
    que classifique o resultado do teste **Human Guide** de um respondente em relação aos campos profissionais segundo Levenfus. .
...
knitr::kable(my.PC.Campo.t[,1:11])
```
