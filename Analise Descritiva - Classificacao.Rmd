...
# inserindo o atributo do componente (positivo ou negativo)
    my.classif <-
        ...
        mutate(atributo = ifelse(scores.pessoa >= 0 & componente == "PC1","OPENNESS",
                         ifelse(scores.pessoa < 0 & componente == "PC1","COMPLIANCE",
                         ifelse(scores.pessoa >= 0 & componente == "PC2","AGREEABLENESS",
                         ifelse(scores.pessoa < 0 & componente == "PC2","FOCO EM RESULTADO",
                         ifelse(scores.pessoa >= 0 & componente == "PC3","RESEARCH ORIENTED",
                         ifelse(scores.pessoa < 0 & componente == "PC3","COMMITMENT",
                         ifelse(scores.pessoa >= 0 & componente == "PC4","PEOPLE ORIENTED",
                         ifelse(scores.pessoa < 0 & componente == "PC4","TASK ORIENTED",
                         ifelse(scores.pessoa >= 0 & componente == "PC5","EXTROVERSION",
                         ifelse(scores.pessoa < 0 & componente == "PC5","SOBRIEDADE",
                         ifelse(scores.pessoa >= 0 & componente == "PC6","MANAGEMENT",
                         ifelse(scores.pessoa < 0 & componente == "PC6","RECEPTIVIDADE ATIVA",
                         ifelse(scores.pessoa >= 0 & componente == "PC7","PONDERAÇÃO",
                         "ADAPTABILIDADE"
        ))))))))))))))
