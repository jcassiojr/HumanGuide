...
f_train_model_HG_prof <- function(df_train_in, df_test_in, campo_in) {
    
    #preparando modelo para target campo = CFM
    df_train_in <- my.train.atua
    df_test_in <- my.test.atua
    campo_in <- 45
    # 86(49) 13(0.4983965) 76(0.5335106) 73(0.5302266) 71(0.5392586)  1(0.4996424) 70(0.592213) 46(0.6112179)  3(0.504911)
    # 12(0.4832399) 45 79 35 81  8  4  6 17 10 15 39 23
