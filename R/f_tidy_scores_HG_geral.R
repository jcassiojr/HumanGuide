...
f_tidy_scores_HG_geral <- function(df_in) {
    ...
    df_in <-
        ...
        select(ID, nomerespondente, sexo, idade, atua.em.1, atua.em.2, atua.em.3, 
               cidade, uf, profissao.na.area.de, formacao.em,
    ...
    df_out <-
        ...
        select(ID, nomerespondente, sexo, idade, atua.em.1, atua.em.2, atua.em.3, cidade, uf, profissao.na.area.de, formacao.em, sensibility, power, quality,
