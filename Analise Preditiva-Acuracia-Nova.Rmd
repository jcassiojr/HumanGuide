...
Como a análise baseada nas assinaturas de baseline dos campos profisisonais versus profissão, depois versus formação e atua.na.area.1 não apresentaram boa acurácia (em torno de 45% para os primeiros, 33% para o último), será tentada a análise abaixo:
+ primeiro considerando nova abordagem ao invés da assinatura dos campos profissionais


#### Nova Abordagem de Campos Profissionais ####
