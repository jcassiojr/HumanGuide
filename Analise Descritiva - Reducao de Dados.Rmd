...
### Plotando os scores médios de acordo com sexo do respondente ###

Abaixo, plotamos os scores médios para os componentes, de forma a identificar o comportamento dos scores segundo o sexo dos respondentes.

```{r, echo=FALSE}
# cluster por sexo
# obtendo o score médio por formacao
# OBS: repetir esta análise para agrupar por campo de atividade
my.prev.gender <- cbind(sexo = my.newdata$sexo, my.prev)
my.prev.gender <-
    my.prev.gender %>%
    group_by(sexo) %>%
    summarise(PC1.medio = mean(PC1),
...
#pc1 <- plot_ly(my.prev.gender, x = PC1.medio, y = PC2.medio, color = sexo, type = "scatter", mode = "markers")
#pc1 <- layout(pc1, title = "Scores Médios por Sexo - PC1 x PC2")
#pc1
### setting parameters
#par(mfrow = c(2,2), mar =c(5,4,2,1))
# plot PC1 x PC2
...
# box plot
pc7 <- plot_ly(my.prev.gender, x = PC7, color = sexo, type = "box")
...
plot(my.prev.gender$PC1.medio, my.prev.gender$PC2.medio, 
     col=my.prev.gender$sexo,
     #col=c(1,2,3),
     main = "Clusters por Sexo (PC1 x PC2)",
     xlab = "PC1", ylab = "PC2")
legend("topright", inset=.05,
       bty="n", cex=.5,
       title="Sexo",
       c("Masculino", "Feminino"), fill=c("red", "black"))

# plot PC2 x PC3
plot(my.prev.gender$PC2.medio, my.prev.gender$PC3.medio, 
     col=my.prev.gender$sexo,
     #col=c(1,2,3),
     main = "Clusters por Sexo (PC2 x PC3)",
     xlab = "PC2", ylab = "PC3")
legend("topright", inset=.05,
       bty="n", cex=.5,
       title="Sexo",
...
# plot PC1 x PC3
plot(my.prev.gender$PC1.medio, my.prev.gender$PC3.medio, 
     col=my.prev.gender$sexo,
     #col=c(1,2,3),
     main = "Clusters por Sexo (PC1 x PC3)",
     xlab = "PC1", ylab = "PC3")
legend("topright", inset=.05,
       bty="n", cex=.5,
       title="Sexo",
...
#p <- plot_ly(my.prev.gender, x = PC1.medio, color = sexo, type = "box")
#p
```
