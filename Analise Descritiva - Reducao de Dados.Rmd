...
my.descr <- describe(df_tidy_hg[,6:13])
#print(my.descr)
...
# correlação de spearman
    my.cor <- cor(df_tidy_hg[,6:13], method = "spearman")
...
```{r, echo=FALSE}
    pca1 = prcomp(df_tidy_hg[,6:13], scale. = TRUE, center = TRUE)
    print (pca1$sdev)
...
```{r, echo=FALSE}
    ...
    knitr::kable(head(my.prev[,c(1,2,3,12:14)], n = 10))
```
