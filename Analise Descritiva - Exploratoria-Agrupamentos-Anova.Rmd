---
title: "Análise Descritiva - Agrupamentos - DRAFT"
author: "Cassio"
...
Abaixo são apresentados os resultados da análise de variação das médias para todos os grupos considerados nesta análise.
...
```{r, echo=FALSE, warning=FALSE}
### Análise de Variância da Médias por Componente ###

# A análise acima foi discriminada por componente também, para cada grupo, usando a técnica
# Multiple Variance Analysis (MANOVA), de forma a confirmar que as médias dos scores também 
# apresentam diferença significativa para cada componente individualmente (p-value < 0.05).
...
#boxplot(PC1~tipouser,data=my.aov.tipouser)
```
